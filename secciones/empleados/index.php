...
if(isset($_GET["txtID"])){
    ...
    //Buscar el archivo relacioando con el empleados
        ...
        <table class="table" id="tabla_id">
            ...
            <?php foreach($lista_tbl_empleados as $registro) {?>
                <tr class="">
                    ...
                    <td><?php echo $registro['primernombre']; ?> <?php echo $registro['segundonombre']; ?>
                    <?php echo $registro['primerapellido']; ?> <?php echo $registro['segundoapellido']; ?></td>
                    <td>
