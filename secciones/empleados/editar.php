...
<div class="card">
    ...
    <div class="mb-3">
      ...
      value="<?php echo $primernombre; ?>"
        class="form-control" name="primernombre" id="primernombnre" aria-describedby="helpId" placeholder="Primer Nombre">
    </div>
    ...
    <div class="mb-3">
      ...
      value="<?php echo $segundonombre; ?>"
        class="form-control" name="segundonombre" id="segundonombnre" aria-describedby="helpId" placeholder="Segundo Nombre">
    </div>
